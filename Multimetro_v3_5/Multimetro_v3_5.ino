...
//char V[MULTI_VARS_SIZE]="a", I[MULTI_VARS_SIZE]="a", P[MULTI_VARS_SIZE]="a", S[MULTI_VARS_SIZE]="a", Q[MULTI_VARS_SIZE]="a", FP[MULTI_VARS_SIZE]="a", V_FFT[MULTI_VARS_SIZE]="a", I_FFT[MULTI_VARS_SIZE]="a", P_FFT[MULTI_VARS_SIZE]="a", S_FFT[MULTI_VARS_SIZE]="a", Q_FFT[MULTI_VARS_SIZE]="a", FP_FFT[MULTI_VARS_SIZE]="a";
//#define THD_VARS_SIZE 6
//char arm_1[THD_VARS_SIZE]="a", arm_2[THD_VARS_SIZE]="a", THD_var[THD_VARS_SIZE]="a";
